...
VOICEOBJS = VoiceApp.o TFInference/VoiceInference.o
...
VoiceApp.o: VoiceApp.cpp VoiceApp.hpp TFInference/VoiceInference.hpp
...
clean:
	...
	rm -f VoiceApp.o TFInference/VoiceInference.o VoiceApp
...
transfer:
	...
	scp -r VoiceApp.cpp VoiceApp.hpp voice_model/*.tflite dev@192.168.68.105:/home/dev/Pico-Assistant/
